...
//        sqLiteDatabase.execSQL(dbNhanVien);
        ...
        String dbPhong = "create table Phong(maPhong integer primary key autoincrement,TenPhong text, giaThue integer,trangThai text, maLoai text references LoaiPhong(maLoai))";
